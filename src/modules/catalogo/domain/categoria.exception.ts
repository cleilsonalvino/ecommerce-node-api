...
class NomeCategoriaNuloOuIndefinido extends CategoriaException{
    constructor(message: string = 'O nome da categoria é nulo ou indefinido.'){
        super(message);
...
class NomeCategoriaTamanhoMinimoInvalido extends CategoriaException{
    constructor(message: string = 'O nome da categoria não possui um tamanho mínimo válido.'){
        super(message);
...
class NomeCategoriaTamanhoMaximoInvalido extends CategoriaException{
    constructor(message: string = 'O nome da categoria não possui um tamanho máximo válido.'){
        super(message);
